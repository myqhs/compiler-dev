...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // Index
      char dummy2[sizeof (mind::ast::DimList* )];

      // ForExpr
      // LvalueExpr
      // Expr
      char dummy3[sizeof (mind::ast::Expr*)];

      // ExprList
      char dummy4[sizeof (mind::ast::ExprList* )];

      // FuncDefn
      char dummy5[sizeof (mind::ast::FuncDefn* )];

      // IndexExpr
      char dummy6[sizeof (mind::ast::IndexExpr*)];

      // Program
      // FoDList
      char dummy7[sizeof (mind::ast::Program* )];
      ...
      // ReturnStmt
      // ExprStmt
      char dummy8[sizeof (mind::ast::Statement*)];

      // StmtList
      char dummy9[sizeof (mind::ast::StmtList*)];

      // Type
      char dummy10[sizeof (mind::ast::Type*)];

      // FormalList
      // ParameterList
      char dummy11[sizeof (mind::ast::VarList* )];

      // VarRef
      char dummy12[sizeof (mind::ast::VarRef*)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_FoDList = 46,                          // FoDList
        S_FuncDefn = 47,                         // FuncDefn
        S_FormalList = 48,                       // FormalList
        S_ParameterList = 49,                    // ParameterList
        S_Type = 50,                             // Type
        S_StmtList = 51,                         // StmtList
        S_Stmt = 52,                             // Stmt
        S_CompStmt = 53,                         // CompStmt
        S_WhileStmt = 54,                        // WhileStmt
        S_ForStmt = 55,                          // ForStmt
        S_ForExpr = 56,                          // ForExpr
        S_IfStmt = 57,                           // IfStmt
        S_DeclStmt = 58,                         // DeclStmt
        S_Index = 59,                            // Index
        S_ReturnStmt = 60,                       // ReturnStmt
        S_ExprStmt = 61,                         // ExprStmt
        S_VarRef = 62,                           // VarRef
        S_LvalueExpr = 63,                       // LvalueExpr
        S_IndexExpr = 64,                        // IndexExpr
        S_ExprList = 65,                         // ExprList
        S_Expr = 66                              // Expr
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_Index: // Index
        value.move< mind::ast::DimList*  > (std::move (that.value));
        break;

      case symbol_kind::S_ForExpr: // ForExpr
      case symbol_kind::S_LvalueExpr: // LvalueExpr
      case symbol_kind::S_Expr: // Expr
        value.move< mind::ast::Expr* > (std::move (that.value));
        break;

      case symbol_kind::S_ExprList: // ExprList
        value.move< mind::ast::ExprList*  > (std::move (that.value));
        break;

      case symbol_kind::S_FuncDefn: // FuncDefn
        value.move< mind::ast::FuncDefn*  > (std::move (that.value));
        break;

      case symbol_kind::S_IndexExpr: // IndexExpr
        value.move< mind::ast::IndexExpr* > (std::move (that.value));
        break;

      case symbol_kind::S_Program: // Program
      case symbol_kind::S_FoDList: // FoDList
        value.move< mind::ast::Program*  > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_ExprStmt: // ExprStmt
        value.move< mind::ast::Statement* > (std::move (that.value));
        break;

      case symbol_kind::S_StmtList: // StmtList
        value.move< mind::ast::StmtList* > (std::move (that.value));
        break;

      case symbol_kind::S_Type: // Type
        value.move< mind::ast::Type* > (std::move (that.value));
        break;

      case symbol_kind::S_FormalList: // FormalList
      case symbol_kind::S_ParameterList: // ParameterList
        value.move< mind::ast::VarList*  > (std::move (that.value));
        break;

      case symbol_kind::S_VarRef: // VarRef
        value.move< mind::ast::VarRef* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::DimList* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::DimList* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::Expr*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::Expr*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::ExprList* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::ExprList* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::FuncDefn* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::FuncDefn* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::IndexExpr*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::IndexExpr*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::Program* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::Program* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::Statement*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::Statement*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::StmtList*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::StmtList*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::Type*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::Type*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::VarList* && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::VarList* & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mind::ast::VarRef*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mind::ast::VarRef*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_Index: // Index
        value.template destroy< mind::ast::DimList*  > ();
        break;

      case symbol_kind::S_ForExpr: // ForExpr
      case symbol_kind::S_LvalueExpr: // LvalueExpr
      case symbol_kind::S_Expr: // Expr
        value.template destroy< mind::ast::Expr* > ();
        break;

      case symbol_kind::S_ExprList: // ExprList
        value.template destroy< mind::ast::ExprList*  > ();
        break;

      case symbol_kind::S_FuncDefn: // FuncDefn
        value.template destroy< mind::ast::FuncDefn*  > ();
        break;

      case symbol_kind::S_IndexExpr: // IndexExpr
        value.template destroy< mind::ast::IndexExpr* > ();
        break;

      case symbol_kind::S_Program: // Program
      case symbol_kind::S_FoDList: // FoDList
        value.template destroy< mind::ast::Program*  > ();
        break;
      ...
      case symbol_kind::S_ReturnStmt: // ReturnStmt
      case symbol_kind::S_ExprStmt: // ExprStmt
        value.template destroy< mind::ast::Statement* > ();
        break;

      case symbol_kind::S_StmtList: // StmtList
        value.template destroy< mind::ast::StmtList* > ();
        break;

      case symbol_kind::S_Type: // Type
        value.template destroy< mind::ast::Type* > ();
        break;

      case symbol_kind::S_FormalList: // FormalList
      case symbol_kind::S_ParameterList: // ParameterList
        value.template destroy< mind::ast::VarList*  > ();
        break;

      case symbol_kind::S_VarRef: // VarRef
        value.template destroy< mind::ast::VarRef* > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        YY_ASSERT (tok == token::TOK_END
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_CONST)
                   || tok == token::TOK_NEG);
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_Index: // Index
        value.copy< mind::ast::DimList*  > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_ForExpr: // ForExpr
      case symbol_kind::S_LvalueExpr: // LvalueExpr
      case symbol_kind::S_Expr: // Expr
        value.copy< mind::ast::Expr* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_ExprList: // ExprList
        value.copy< mind::ast::ExprList*  > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_FuncDefn: // FuncDefn
        value.copy< mind::ast::FuncDefn*  > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_IndexExpr: // IndexExpr
        value.copy< mind::ast::IndexExpr* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_Program: // Program
      case symbol_kind::S_FoDList: // FoDList
        value.copy< mind::ast::Program*  > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_ReturnStmt: // ReturnStmt
      case symbol_kind::S_ExprStmt: // ExprStmt
        value.copy< mind::ast::Statement* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_StmtList: // StmtList
        value.copy< mind::ast::StmtList* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_Type: // Type
        value.copy< mind::ast::Type* > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_FormalList: // FormalList
      case symbol_kind::S_ParameterList: // ParameterList
        value.copy< mind::ast::VarList*  > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_VarRef: // VarRef
        value.copy< mind::ast::VarRef* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_Index: // Index
        value.move< mind::ast::DimList*  > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_ForExpr: // ForExpr
      case symbol_kind::S_LvalueExpr: // LvalueExpr
      case symbol_kind::S_Expr: // Expr
        value.move< mind::ast::Expr* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_ExprList: // ExprList
        value.move< mind::ast::ExprList*  > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_FuncDefn: // FuncDefn
        value.move< mind::ast::FuncDefn*  > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_IndexExpr: // IndexExpr
        value.move< mind::ast::IndexExpr* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_Program: // Program
      case symbol_kind::S_FoDList: // FoDList
        value.move< mind::ast::Program*  > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_ReturnStmt: // ReturnStmt
      case symbol_kind::S_ExprStmt: // ExprStmt
        value.move< mind::ast::Statement* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_StmtList: // StmtList
        value.move< mind::ast::StmtList* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_Type: // Type
        value.move< mind::ast::Type* > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_FormalList: // FormalList
      case symbol_kind::S_ParameterList: // ParameterList
        value.move< mind::ast::VarList*  > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_VarRef: // VarRef
        value.move< mind::ast::VarRef* > (YY_MOVE (s.value));
        break;
